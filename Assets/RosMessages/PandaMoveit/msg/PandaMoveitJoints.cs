...
{
    public class PandaMoveitJoints : Message
    {
        public const string RosMessageName = "panda_moveit/PandaMoveitJoints";
        ...
        public PandaMoveitJoints(double joint_00, double joint_01, double joint_02, double joint_03, double joint_04, double joint_05, double joint_06)
        {
