...
namespace RosMessageTypes.PandaMoveit
{
    ...
    {
        public const string RosMessageName = "panda_moveit/TrajectoryService";

        public PandaMoveitJoints joints_input;
        ...
        {
            this.joints_input = new PandaMoveitJoints();
            this.pick_pose = new Geometry.Pose();
            this.waypoints = new Geometry.Pose[0];
            this.place_pose = new Geometry.Pose();
        }

        public TrajectoryServiceRequest(PandaMoveitJoints joints_input, Geometry.Pose pick_pose, Geometry.Pose[] waypoints, Geometry.Pose place_pose)
        {
