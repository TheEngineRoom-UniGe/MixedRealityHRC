...
from panda_moveit.msg import PandaTrajectory
from panda_moveit.srv import TrajectoryService, TrajectoryServiceRequest, TrajectoryServiceResponse

# Global variables
joint_names = ['panda_joint1', 'panda_joint2', 'panda_joint3', 'panda_joint4', 'panda_joint5', 'panda_joint6', 'panda_joint7']
trajectory_publisher = rospy.Publisher('panda_joint_trajectory', PandaTrajectory, queue_size=10)
...
def moveit_server():
    ...
    s = rospy.Service('panda_moveit_trajectory', TrajectoryService, plan_pick_and_place)
