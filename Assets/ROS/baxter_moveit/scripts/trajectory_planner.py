...
def plan_cartesian_trajectory(move_group, limb, destination_pose, start_joint_angles):
    ...
    (plan, fraction) = move_group.compute_cartesian_path([destination_pose], 0.15, 0.0)
...
def spawn_obstacles(scene):
    ...
    scene.add_box("table", p1, (2, 2, 0.675))
    ...
    print("Obstacles added to scene..")
    
def moveit_server():

    moveit_commander.roscpp_initialize(sys.argv) 
    s = rospy.Service('baxter_moveit_trajectory', TrajectoryService, dispatcher)
