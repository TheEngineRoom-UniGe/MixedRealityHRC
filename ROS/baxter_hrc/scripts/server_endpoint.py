...
def main():
    ...
    tcp_server.start({
        ...
        'left_group/baxter_hrc_trajectory': RosService('left_group/baxter_hrc_trajectory', ActionService),
        'right_group/baxter_hrc_trajectory': RosService('right_group/baxter_hrc_trajectory', ActionService),
